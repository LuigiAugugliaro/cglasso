...
H <- 25             # maximum number of variable that may be censored
...
for(j in 1:nsim){
    ...
    if(j %in% (10 * (1:10))) save.image("model_1_H25_tmp.RData")
}

save.image("model_1_H25.RData")
