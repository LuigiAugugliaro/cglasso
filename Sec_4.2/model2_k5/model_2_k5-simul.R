...
k <- 5              # parameter used to control the parsity in Theta
...
for(j in 1:nsim){
    ...
    if(j %in% (10 * (1:10))) save.image("model_2_k5_tmp.RData")
}

save.image("model_2_k5.RData")
